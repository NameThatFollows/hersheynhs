    ...
    <body>
        ...
        <?php 
            if (isset($_POST['edit'])) {
                ...
                echo '<div class="half halfleft"><label>Start Date</label><input id="startdate" name="startdate" type="date" value="'.$eventData['startdate'].'"/></div>';
                echo '<div class="half halfright"><label>End Date</label><input id="enddate" name="enddate" type="date" value="'.$eventData['enddate'].'"/></div>';
